...
module.exports = schsrch =>
  describe('Search for specific paper', function () {
    ...
    ;['0610 ', '0610'].forEach(s => {
      ...
      dsTest(s + '1', ['s08_1_0_qp', 's16_1_0_ms', 's16_1_0_qp', 's17_1_1_ms', 's17_1_1_qp', 's17_1_2_qp', 's17_1_2_ms', 'w16_1_1_qp', 'w16_1_1_ms'])
      ...
      dsTest(s + '11', ['s17_1_1_ms', 's17_1_1_qp'])
      dsTest(s + 'p11', ['s17_1_1_ms', 's17_1_1_qp'])
      dsTest(s + 'paper 11', ['s17_1_1_ms', 's17_1_1_qp'])
      dsTest(s + '0', [])
      dsTest(s + 'p0', [])
      dsTest(s + 'paper 0', [])
