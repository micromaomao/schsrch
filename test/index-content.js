...
module.exports = () =>
  describe('Full text index content (tokenize, sort, etc.)', function () {
    ...
    it('lcsLength', function () {
      ...
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize('fox jumps over the')).should.equal(4)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps the lazy dog.'), IndexContent.tokenize('fox jumps over the')).should.equal(3)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize('fox jumps the')).should.equal(3)
      IndexContent.lcsLength(IndexContent.tokenize('big fox jumps over the lazy dog.'), IndexContent.tokenize('fox jumps the')).should.equal(3)
      IndexContent.lcsLength(IndexContent.tokenize('big fox Jumps over the lazy dog.'), IndexContent.tokenize('fox jumps the')).should.equal(3)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox Jumps over the lazy dog.'), IndexContent.tokenize('the fox jumps the dog')).should.equal(5)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox Jumps over the lazy dog.'), IndexContent.tokenize('the jumps fox the dog')).should.equal(4)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize('the fox  jumps the dog')).should.equal(5)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize(' the   jumps fox the dog')).should.equal(4)
      ...
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize('what so ever')).should.equal(0)
      IndexContent.lcsLength(IndexContent.tokenize('The big fox jumps over the lazy dog.'), IndexContent.tokenize('the the')).should.equal(2)
