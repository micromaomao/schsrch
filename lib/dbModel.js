module.exports = (db, mongoose) => {
  ...
  indexSchema.static('search', query => new Promise((resolve, reject) => {
    ...
    aggreArray.push({$project: {tDoc: {$arrayElemAt: ['$doc', 0]}, _id: true, doc: "Document content not sent.", content: true, page: true}})
    aggreArray.push({$addFields: {'tDoc.doc': "Document content not sent."}})
    if (queryPerfixMatch) {
