module.exports = (db, mongoose) => {
  ...
  indexSchema.static('search', query => new Promise((resolve, reject) => {
    ...
    let aggreArray = [{$match: {$text: {$search: query}}}]
    ...
    aggreArray.push({$project: {tDoc: {$arrayElemAt: ['$doc', 0]}, _id: true, doc: true, content: true, page: true}})
    aggreArray.push({$project: {'tDoc.doc': false, 'doc': false}})
